...
本文件只负责界面和用户交互；控制逻辑位于 ur_takeover_v2.py。
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("UR同构遥操作 · 示教回放 · 7轴人工接管")
    ...
    def _build_replay_group(self, parent):
        ...
        g.addWidget(QLabel("主端 MIT Kp"), 0, 0)
        g.addWidget(self.replay_kp, 0, 1)
        g.addWidget(QLabel("主端 MIT Kd"), 1, 0)
